...
public class TicTacToeGUI extends Canvas implements MouseListener
{
    ...
    public void paint(Graphics g) {
        ...
        if (! started) {
            ...
            g.setFont(new Font("Tacoma", Font.BOLD, 60));
            g.drawString("Let's play!", 275, 400);
        }
        else {
            drawEmptyBoard(g);
            for (int r=0; r<3; r++)
            ...
            if (gameOver) {
                g.setFont(new Font("Tacoma", Font.BOLD, 144));
                g.setColor( Color.blue );
                if (ttt.isWinner('X'))
                ...
                if (ttt.isCat())
                    g.drawString("TIE!", 50, 400);
            }
            else {
                g.setFont(new Font("Tacoma", Font.BOLD, 72));
                g.setColor(Color.blue);
